...
<head>
    ...
    <style>
        ...
        .topnav a.active {background-color: #0470aa;color: white;}
        .topnav .icon {
            display: none;}
...
@media screen and (max-width: 600px) {            .topnav.responsive .icon {position: absolute;right: 0;top: 0;}.topnav.responsive a float: none;display: block;text-align: left;}  }
    </style>
</head>
<style>
    .card {float: left;position: relative;left: 50px;align-content: space-between;box-shadow: 0 4px 20px 0 rgba(0, 0, 0, 0.2);max-width: 250px;margin: auto;text-align: center;font-family: Calibri;
    }

    .price {color: #05050c;font-size: 20px;
    }
...
<div class="topnav" id="myTopnav">
    <style>
        .card {box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2);transition: 0.3s;width: 40%;
        }
